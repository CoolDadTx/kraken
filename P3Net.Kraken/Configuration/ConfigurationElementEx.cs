/*
 * Provides enhanced support for configuration elements.
 *
...
{
	/// <summary>Provides enhanced support for <see cref="ConfigurationElement"/> instances.</summary>
	/// <remarks>
	/// <see cref="ConfigurationElementEx"/> provides support for setting up a configuration element
	...
	public abstract class ConfigurationElementEx : ConfigurationSection
	{
		...
		/// </remarks>
		protected static void LoadProperties ( ConfigurationElementEx element )
		{
		...
		{
			Debug.Assert(element is ConfigurationElementEx, "Element is not ConfigurationElementEx.");

			return ((ConfigurationElementEx)element).GetBaseProperties();
		}
		#endregion
