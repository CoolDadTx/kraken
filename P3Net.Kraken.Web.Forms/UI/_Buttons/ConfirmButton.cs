...
{
	/// <summary>A <see cref="Button"/> that displays a client-side confirmation message.</summary>
	/// <preliminary/>
	/// <remarks>
	/// At this time the <see cref="Button.OnClientClick">OnClientClick</see> property is ignored.
	/// <para/>
