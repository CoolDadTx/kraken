...
{
	/// <summary>A <see cref="LinkButton"/> that displays a client-side confirmation message.</summary>
	/// <remarks>
	/// At this time the <see cref="LinkButton.OnClientClick">OnClientClick</see> property is ignored.
	/// <para/>
